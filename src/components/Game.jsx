...
const chapters = {
  ...
  perfil: {
    id: "perfil",
    title: "Perfil",
    text: "Após 10 anos de experiência em jornalismo económico, tomei a decisão de abraçar um novo desafio, e fiz a reconversão profissional para uma área que, de certa forma, sempre me acompanhou: o código e a lógica.",
    choices: [
